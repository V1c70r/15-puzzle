...
var app = (function () {
    ...
    function create_each_block_2(key_1, ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[4](/*number*/ ctx[12]);
    	}
    	...
    	const block = {
    		...
    		c: function create() {
    			td = element("td");
    			t = text(t_value);
    			attr_dev(td, "class", "svelte-gimirl");
    			add_location(td, file, 13, 10, 260);
    			this.first = td;
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*numbers*/ 1 && t_value !== (t_value = (/*number*/ ctx[12] || "") + "")) set_data_dev(t, t_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(13:8) {#each rows as number, x (x)}",
    		ctx
    	});
    ...
    // (11:4) {#each numbers as rows, y (y)}
    function create_each_block_1(key_1, ctx) {
    	let tr;
    	let each_blocks = [];
    	let each_1_lookup = new Map();
    	let t;
    	let each_value_2 = /*rows*/ ctx[9];
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*onMove, numbers*/ 9) {
    				each_value_2 = /*rows*/ ctx[9];
    				validate_each_argument(each_value_2);
    				validate_each_keys(ctx, each_value_2, get_each_context_2, get_key);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(11:4) {#each numbers as rows, y (y)}",
    		ctx
    	});
    ...
    function create_each_block(key_2, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			attr_dev(p, "class", p_class_value = "log-" + /*type*/ ctx[5] + " svelte-gimirl");
    			add_location(p, file, 21, 4, 429);
    			this.first = p;
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*logs*/ 2 && t_value !== (t_value = /*text*/ ctx[6] + "")) set_data_dev(t, t_value);

    			if (dirty & /*logs*/ 2 && p_class_value !== (p_class_value = "log-" + /*type*/ ctx[5] + " svelte-gimirl")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(21:2) {#each logs as {type, text}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value_1 = /*numbers*/ ctx[0];
    	validate_each_argument(each_value_1);
    	const get_key = ctx => /*y*/ ctx[11];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 7, 0, 105);
    			add_location(tbody, file, 9, 2, 158);
    			add_location(table, file, 8, 0, 148);
    			add_location(div, file, 19, 0, 376);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*onNew*/ ctx[2])) /*onNew*/ ctx[2].apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*numbers, onMove*/ 9) {
    				each_value_1 = /*numbers*/ ctx[0];
    				validate_each_argument(each_value_1);
    				validate_each_keys(ctx, each_value_1, get_each_context_1, get_key);
    				each_blocks_1 = update_keyed_each(each_blocks_1, dirty, get_key, 1, ctx, each_value_1, each0_lookup, tbody, destroy_block, create_each_block_1, null, get_each_context_1);
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { onNew } = $$props;
    	let { onMove } = $$props;
    	const writable_props = ["numbers", "logs", "onNew", "onMove"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Board> was created with unknown prop '${key}'`);
    	});

    	const click_handler = number => onMove(number);

    	$$self.$$set = $$props => {
    		if ("numbers" in $$props) $$invalidate(0, numbers = $$props.numbers);
    		if ("logs" in $$props) $$invalidate(1, logs = $$props.logs);
    		if ("onNew" in $$props) $$invalidate(2, onNew = $$props.onNew);
    		if ("onMove" in $$props) $$invalidate(3, onMove = $$props.onMove);
    	};

    	$$self.$capture_state = () => ({ numbers, logs, onNew, onMove });
    	...
    	return [numbers, logs, onNew, onMove, click_handler];
    }

    class Board extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { numbers: 0, logs: 1, onNew: 2, onMove: 3 });
    		...
    		if (/*numbers*/ ctx[0] === undefined && !("numbers" in props)) {
    			console.warn("<Board> was created without expected prop 'numbers'");
    		}

    		if (/*logs*/ ctx[1] === undefined && !("logs" in props)) {
    			console.warn("<Board> was created without expected prop 'logs'");
    		}

    		if (/*onNew*/ ctx[2] === undefined && !("onNew" in props)) {
    			console.warn("<Board> was created without expected prop 'onNew'");
    		}

    		if (/*onMove*/ ctx[3] === undefined && !("onMove" in props)) {
    			console.warn("<Board> was created without expected prop 'onMove'");
    		}
    	}
     ...
     */
    function isSolvable(emptinessIndex, numberWithoutEmptiness) {
     ...
     */
    function mergeAndCountInversions(array1, array2) {
        const totalLen = array1.length + array2.length;
        const array = Array(totalLen);
        let count = 0;
        let index1 = 0;
        let index2 = 0;
    ...
    class Board$1 {
        ...
        createRandomState() {
            const flatNumbers = lodash.shuffle(lodash.range(1, this.config.maxNumber + 1));
            const emptinessIndex = lodash.random(0, this.config.maxNumber);
            ...
            return {
                ...
                numbers: lodash.chunk(flatNumbers, this.config.sideSize),
            };
        }
        /**
     ...
     */
    class Puzzle {
        constructor({ boardConfig, storage, display, input, i18n, processExit, }) {
        ...
        createNewBoard() {
            this.board = new Board$1({ config: this.boardConfig });
        ...
        loadBoard() {
            ...
            if (state) {
                this.board = new Board$1({ config: this.boardConfig, state });
    ...
    class SvelteEnI18n {
        constructor() {
            this.inputPrompt = '';
            this.greeting = 'Come in, Chosen One.';
            this.goodbye = 'Goodbye!';
            this.newGameCreated = 'New game started.';
            this.gameLoaded = 'Game is loaded.';
            this.congratulation = 'WIN!';
            this.unknownCommand = 'Something wrong happened.';
            this.help = 'Click on a number to move it.';
        }
        cantMoveNumber(number) {
    ...
    const svelteDisplayConfig = {
        logSize: 5,
        clearLogTimeoutMs: 5000,
    };

    /* src/bootstrap.svelte generated by Svelte v3.32.3 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			const board_changes = {};
    			if (dirty & /*logs*/ 1) board_changes.logs = /*logs*/ ctx[0];
    			if (dirty & /*numbers*/ 2) board_changes.numbers = /*numbers*/ ctx[1];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Bootstrap", slots, []);
    	...
    	const updateLog = () => {
    		$$invalidate(0, logs = display.getLogs());
    	};

    	const update = () => {
    		updateLog();
    		$$invalidate(1, numbers = display.getNumbers());
    	};
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Bootstrap> was created with unknown prop '${key}'`);
    	});
    	...
    	return [logs, numbers, onNew, onMove];
    }

    class Bootstrap extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
